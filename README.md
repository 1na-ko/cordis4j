...
> Status: v0.4.1 - **incubating**. Semantics follow the formal model in
...
```console
mvn verify   # enforcer + spotless + tests (T1-T64, 222 tests) + jacoco (>= 85%) + javadoc + dependency analysis
```
