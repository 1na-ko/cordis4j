...
> Status: v0.4.2 - **incubating**. Semantics follow the formal model in
...
```console
mvn verify   # enforcer + spotless + tests (T1-T93, 252 tests) + jacoco (line >= 85%, branch >= 80%) + javadoc + dependency analysis
```
